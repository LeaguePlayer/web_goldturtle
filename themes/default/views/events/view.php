...
<ul class="event_switcher">
    <li class="<?php if ($model->type == Events::TYPE_NEWS) echo "current "; ?>news">
        <a href="<?=Events::getNewsUrl($this->place);?>"\>Новости ресторана</a>
    </li>
    <li class="<?php if ($model->type == Events::TYPE_CHRONICLE) echo "current "; ?>chronicle">
        <a href="<?=Events::getChroniclesUrl($this->place);?>">Светская хроника</a>
    </li>
</ul>
